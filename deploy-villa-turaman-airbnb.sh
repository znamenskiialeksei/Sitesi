...
echo -e "  5. Нажмите: ${CYAN}🤖 Telegram Бот ➔ ⚙️ 6. Настройки Webhook и Токена ➔ 🔑 Настроить TELEGRAM_BOT_TOKEN и CHAT_ID${RESET}."
echo -e "  6. Установите Webhook: ${CYAN}🤖 Telegram Бот ➔ ⚙️ 6. Настройки Webhook и Токена ➔ 🔗 Установить Webhook на сайт${RESET}."
