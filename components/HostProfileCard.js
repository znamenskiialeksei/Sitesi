        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
              Суперхозяин с 2022 года • Владелец Villa Turaman
            </p>
            <div className="flex flex-wrap gap-2 mt-2">
              <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-emerald-400 bg-emerald-500/10 px-2.5 py-0.5 rounded-full border border-emerald-500/20">
                <ShieldCheck className="w-3 h-3" /> Личность подтверждена
              </span>
              <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-amber-300 bg-amber-500/10 px-2.5 py-0.5 rounded-full border border-amber-500/20">
                <Clock className="w-3 h-3" /> Ответ в течение 1 часа
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full md:w-auto">
          <div className="text-xs text-slate-300 space-y-1">
            <div className="flex items-center gap-1.5 text-slate-400">
              ...
              <span>Языки: Русский, English, Türkçe</span>
            </div>
            <p className="text-[11px] text-slate-400">
              Быстрая помощь с трансферами, арендой яхт и рекомендациями.
            </p>
          </div>
          ...
          {currentUser ? (
            ...
            >
              <MessageCircle className="w-4 h-4" /> Написать хозяину
            </Link>
          ) : (
            <button
            ...
            >
              <MessageCircle className="w-4 h-4" /> Связаться с хозяином
            </button>
          )}
        </div>
