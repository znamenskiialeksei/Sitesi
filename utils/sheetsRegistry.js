...
const SHEETS_REGISTRY = {
  ...
  BOOKINGS: {
    ...
    cluster: 'host',
    aliases: ['BookingRequests', 'Вилла', 'Бронирования', 'Заявки', 'Заявки и Бронирования', '📋 Заявки и Бронирования'],
  ...
  VARIABLES: {
    ...
    cluster: 'host',
    aliases: ['Placeholders', 'Variables', 'Переменные', 'Словарь переменных', '🧩 Словарь переменных'],
  ...
  SETTINGS: {
    ...
    cluster: 'host',
    aliases: ['Settings', 'Системные настройки', 'Настройки ИИ', '⚙️ Системные настройки', '⚙️ Системные настройки ИИ Агентов'],
