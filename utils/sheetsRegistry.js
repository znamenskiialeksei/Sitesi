...
// Назначение: Обеспечивает 100% стабильную привязку кода к 15 листам Google Таблицы CRM
...
// 
// [ПРЕДЫДУЩАЯ РЕДАКЦИЯ: 26.09.2026 19:40 | ПЛАН: 260920261905 Адаптация задач запускаторов.md | TAG: VILLA-REGISTRY-PREV-260920261940]
// [АКТУАЛЬНАЯ РЕДАКЦИЯ: 26.09.2026 22:50 | ПЛАН: 260920261955 Адаптация скрипта таблицы Code.js.md | TAG: VILLA-REGISTRY-15SHEETS-260920262245]
// ==============================================================================

/**
 * Системная конфигурация 15 листов CRM с каноническими русскими названиями,
 * постоянными sheetId и заголовками колонок.
 * Строгий порядок следования листов от 1 до 15 [Блок 0.2 GEMINI.md].
 */
